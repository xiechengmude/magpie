...
def get_args():
    ...
    parser.add_argument("--control_tasks", type=str, default=None, choices=[None, "translation", "code", "math","writing","toolcalls","roleplay","reasoning"],  help="Control tasks for the generation. Currently only available for some models.")
